...
RSpec.describe 'Orders', type: :request do
  ...
  describe 'DELETE # destroy' do
    ...
    describe 'authenticated user' do
      ...
      context 'when a order can be removed' do
        it { expect { subject }.to change(Order, :count).by(-1) }
        ...
        describe 'and also' do
          ...
          it { expect(flash[:notice]).to eq I18n.t('messages.orders.destroy.success') }
        end
      end

      context 'when a order can not be removed' do
        ...
        describe 'and also' do
          ...
          it { expect(response).to redirect_to orders_path }
          it { expect(flash[:alert]).to eq I18n.t('messages.orders.destroy.failed') }
        end
      end
    end
